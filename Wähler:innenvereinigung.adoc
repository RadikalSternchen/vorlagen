...
[NOTE]
====
Im folgenden werden einige Grundsätze der Zusammenarbeit festgehalten. Darunter fallen der direkten Umgang miteinander genauso wie, dass grundsätzlich asynchron und online gearbetiet und beschlossen wird.
====
...
[NOTE]
====
Die Satzung regelt nur das Gröbste, für alles weitere gibt es einen Verhaltenskodex, den wir empfehen ebenfalls aufzulegen und durchaus mit Biss auszustatten und auch durchzusetzen. UIm
====
...
[TIP]
====
Dies kann z.B. ein Call sein. Grundsätzlich sollte bei diesem Beschluss auch die Beschlussfähigkeit der Zusammenkunft festgelegt werden. Sollte dies ein häufigeres Verfahren sein -- z.B. einmal die Woch einen Call zu haben -- sollte die Beschlussfähigkeit dafür durch einen allgemeinen Verfahrensbeschlluss geregelt werden um Streitigkeiten darüber vorzubeigen.
====
...
[NOTE]
====
Auch wenn die Mitarbeit explizit erwünscht ist, wird den anderen Mitgliedern von Beginn das explizite Recht eingeräumt auch Menschen von einzelllnen Gruppen wieder ausschließen zu dürfen.
====
...
[NOTE]
====
Zeichnungsberechtigt heißt, die Gelder ausgeben zu dürfen. Eine Satzung sollte immer festlegen wer Verträge unterzeichnen darf, andernfalls muss immer der gesamte Vorstand unterzeichnen, was schnell zu einem logitischen Problem wird.
